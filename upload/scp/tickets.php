...
if(isset($_POST["estado_localizador"])){
    ...
    $mysqli->query("UPDATE ost_form_entry_values SET value='".$_POST["estado_localizador"]."' WHERE entry_id = $obj AND field_id =86");
    $mysqli->query("INSERT INTO `ost_ticket__cdata` SET `status_loc`='".$_POST["estado_localizador"]."', `ticket_id`=".$_REQUEST["id"]." ON DUPLICATE KEY UPDATE `status_loc`='".$_POST["estado_localizador"]."'");
}
