        ...
        //13/10/2016 RURIEPE - CREACION DE ARCHIVO PDF
          ...
          //18/11/2016 RURIEPE -ENVIO DE CORREO ELECTRONICO
            ...
            //19/10/2016 RURIEPE - SE INCLUYE ARCHIVO enviar_email.php PARA CAPTURAR EL VALOR DE LA VRAIBLE VALIDACION PARA REALILZAR EL ENVIO DEL CORREO
              ...
              {
                $mensaje = '<p style="font-size:12pt; text-align:justify;">Estimado: <b>'.$nombre_cliente.'</b><br><br> En el siguiente correo usted podra realizar la lectura de los terminos y condiciones generales de TuAgencia24. Luego de realizar la lectura del documento, debe enviar su respesta mediante este correo electronico.</p>';
              }
 
            //19/10/2016 RURIEPE - LLAMADO DE FUNCION Y ENVIO DE LOS VALORES POR PARAMETRO, PARA REALILZAR EL ENVIO DEL CORREO MEDIANTE 
            $envio=enviarEmail($correo_cliente,$asunto,$mensaje,$asesor);
