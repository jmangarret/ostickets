...
if(isset($_GET["est"]))
    $more .= " AND status.state IN ('".str_replace("+","','",$_GET["est"])."')";
if(isset($_GET["top"]))
    $more .= " AND ticket.topic_id IN ('".str_replace("+","','",$_GET["top"])."')";
if(isset($_GET["dep"]))
    $more .= " AND ticket.dept_id IN ('".str_replace("+","','",$_GET["dep"])."')";
if(isset($_GET["sta"])){
    ...
    $more .= " AND cast(cdata.status_loc as char(100) charset utf8) IN ('".str_replace("+","','",$_GET["sta"])."')";
}
