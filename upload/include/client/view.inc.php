...
foreach (DynamicFormEntry::forTicket($ticket->getId()) as $idx=>$form) {
    ...
    <?php } ?>
    <td width="50%">
        <table id="campos" class="infoTable" cellspacing="1" cellpadding="3" width="100%" border="0">
...
// if($("#campos td").eq(8).text() == "")
//     $("#campos tr").eq(8).hide(0);
// if($("#campos td").eq(7).text() == "")
//     $("#campos tr").eq(7).hide(0);
// if($("#campos td").eq(6).text() == "")
//     $("#campos tr").eq(6).hide(0);
// if($("#campos td").eq(5).text() == "")
//     $("#campos tr").eq(5).hide(0);
// if($("#campos td").eq(4).text() == "")
//     $("#campos tr").eq(4).hide(0);
// if($("#campos td").eq(3).text() == "")
//     $("#campos tr").eq(3).hide(0);
// if($("#campos td").eq(2).text() == "")
//     $("#campos tr").eq(2).hide(0);
